"""
Django settings for LabRentPlatform project.
...
SECRET_KEY = 'a63$8+lt-j7d(2wy36+hyx2u9*e=h6d5@9vuc!wn%6*etzve$8'
...
ROOT_URLCONF = 'LabRentPlatform.urls'
...
WSGI_APPLICATION = 'LabRentPlatform.wsgi.application'
