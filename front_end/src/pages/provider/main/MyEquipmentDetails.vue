<template>
    <div class="details">
        ...
        <el-row :gutter="5" style="margin-top: 40px;">
            ...
            <el-col :span="2">
                <el-button type="success" @click="add()">增加设备</el-button>
            </el-col>
            <el-col :span="4">
                <el-input placeholder="数目（正整数）" v-model="num" @blur="number($event)"></el-input>
            </el-col>
            <el-col :span="2">
                <el-button type="danger" @click="minus()">减少设备</el-button>
            </el-col>
        </el-row>
